        ...
        >
          ...
          <button
            className="w-full bg-[#111118] border border-[#1E1E2E]
                       ...
                       rounded-xl py-3.5 flex items-center justify-center gap-3
                       transition-all duration-200"
          >
            <svg width="18" height="18" viewBox="0 0 48 48">
              <path fill="#FFC107"
                d="M43.6 20H24v8h11.3C33.6 33.1 29.3 36 24 36c-6.6
                   0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.8 1.1 7.9
                   3l5.7-5.7C34.2 6.5 29.4 4 24 4 12.9 4 4 12.9 4
                   24s8.9 20 20 20c11 0 19.7-8 19.7-20
                   0-1.3-.1-2.7-.1-4z"/>
              <path fill="#FF3D00"
              ...
              <path fill="#4CAF50"
                d="M24 44c5.2 0 9.9-1.9 13.5-5l-6.2-5.2C29.4
                   35.6 26.9 36.5 24 36.5c-5.2 0-9.6-3.4-11.2-8.1
                   l-6.5 5C9.5 39.4 16.2 44 24 44z"/>
              <path fill="#1976D2"
